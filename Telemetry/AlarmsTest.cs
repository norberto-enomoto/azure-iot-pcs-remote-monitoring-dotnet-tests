...
namespace Telemetry
{
    ...
    public class AlarmsTest : IDisposable
    {
        ...
        public AlarmsTest(ITestOutputHelper logger)
        {
            ...
            this.logger.WriteLine("Check if alarms are being generated");
            if (!this.AlarmsAreGenerated())
            {
                this.logger.WriteLine("Failure -- alarms are not being generated.");
            }
        }
        ...
        private bool AlarmsAreGenerated()
        {
